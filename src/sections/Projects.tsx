...
const portfolioUIUXProjects = [
  ...
  },
  {
    company: "Anisya Hamidah",
    year: "2025",
    title: "Snayzzy style App - UI",
    results: [
      { title: "Tap. Try. Trend." },
      { title: "Discover Styles That Match You" },
  ...
  },
  {
    company: "Anisya Hamidah",
    year: "2024",
    title: "Agro-Vision - UI",
    results: [
      { title: "Scan Once, Check Your Plant’s Health" },
      { title: "Early Detection of Diseases, Including Plant Cancer" },
      { title: "Your Smart Assistant for Plant Health" },
    ],
  ...
  },
  {
    company: "Anisya Hamidah",
    year: "2024",
    title: "Debt Helper App - UI",
    results: [
      { title: "Work Faster, Pay Smarter" },
      { title: "Helping Students in Debt Find Jobs Quickly" },
      { title: "Your Path to Earning and Clearing Your Loans" },
    ],
  ...
  },
  {
    company: "Anisya Hamidah",
    year: "2024",
    title: "Meat Mingle App - UI",
    results: [
      { title: "Fresh Cuts. Great Taste. Delivered." },
      { title: "Premium Beef Selections at Your Fingertips" },
      { title: "Your Trusted Choice for Quality Meat" },
    ],
  ...
  },
  {
    company: "Anisya Hamidah",
    year: "2024",
    title: "Website Pengarsipan Surat - UI",
    results: [
      { title: "Store. Search. Simplify." },
      { title: "A Smart System for Managing All Your Letters" },
      { title: "Your Reliable Digital Archiving Solution" },
    ],
...
const portfolioMobileProjects = [
  {
    company: "Anisya Hamidah",
    year: "2025",
    title: "Snayzzy style App - Flutter",
    results: [
      { title: "Tap. Try. Trend." },
      { title: "Discover Styles That Match You" },
      { title: "Your Personal Style Assistant" },
  ...
  },
  {
    ...
    results: [
      { title: "Pick. Love. Deliver." },
      { title: "Beautiful Flower Selections at Your Fingertips" },
      { title: "Your Fresh & Lovely Flower Shopping Experience" },
    ],
...
const portfolioWebsiteProjects = [
  {
    ...
    results: [
      { title: "Register. Queue. Care." },
      { title: "Easy Online Booking for Your Medical Visit" },
      { title: "Choose Your Preferred Clinic, Skip the Waiting Hassle" },
    ],
